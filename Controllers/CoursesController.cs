...
namespace bs609016_MIS4200_Fixed.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "courseId,description,section,professor,studentId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "courseId,description,section,professor,studentId")] Course course)
        {
            if (ModelState.IsValid)
            {
